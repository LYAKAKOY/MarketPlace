...
async def _get_all_product_by_company_id(id_company: int, elastic_client: AsyncElasticsearch) -> List[
                                                                                                     ShowProduct] | None:
...
async def _get_products_using_filter(product_name: str, min_sum: int, max_sum: int,
                                     elastic_client: AsyncElasticsearch) -> ScrollListProducts | None:
...
async def _get_products_by_match_description(description: str, elastic_client: AsyncElasticsearch) -> List[ShowProduct] | None:
